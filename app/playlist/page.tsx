...
function PlaylistContent() {
  ...
  useEffect(() => {
    ...
    const fetchPlaylist = async () => {
      ...
      const urls = [
        `/api/bmbsong/playlist?id=${encodeURIComponent(cleanId)}&limit=100`,
        `/api/bmbsong/playlist?id=${encodeURIComponent(id)}&limit=100`,
        `/api/bmbsong/play/${encodeURIComponent(cleanId)}`,
        `/api/bmbsong/play/${encodeURIComponent(id)}`,
      ]
