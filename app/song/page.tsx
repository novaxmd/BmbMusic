...
const BASE = process.env.NEXT_PUBLIC_APP_URL || "https://BmbMusic.vercel.app"
...
export async function generateMetadata({
  ...
  const title    = String(sp.title    || "Listen on BmbMusic")
  ...
  const desc = [
    ...
    "Stream free on BmbMusic with live synced lyrics.",
  ].filter(Boolean).join("  •  ")
