      ...
      <div className="container mx-auto px-4 py-8 pb-32">
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-foreground">About BmbSong</h1>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-foreground leading-relaxed">
                BmbSong is a modern, feature-rich music streaming application designed to provide you with the best
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Meet the creator behind BmbSong</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <p className="text-foreground leading-relaxed">
                ...
                streaming infrastructure. I developed the entire backend system for BmbSong, including the music
          ...
          <div className="text-center space-y-2 pt-8 pb-4">
            <p className="text-sm text-muted-foreground">BmbSong v1.0.0</p>
            <p className="text-xs text-muted-foreground">
              Made with <Heart className="w-3 h-3 inline text-red-500 fill-red-500" /> by Shaurya Singh
            </p>
            <p className="text-xs text-muted-foreground">© 2025 BmbSong. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
