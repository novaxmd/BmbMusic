    ...
    <div className="fixed bottom-20 left-4 right-4 z-50 animate-in slide-in-from-bottom-4 duration-300">
      <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-primary text-primary-foreground shadow-xl shadow-primary/30">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-sm">Install BmbMusic</p>
    ...
    async function checkClipboard() {
      try {
        ...
        if (parsed) {
          ...
          const label = ts > 0 ? `Play from ${fmtTime(ts)}` : "Play in BmbMusic"
          setPasteUrl(text)
          setPasteLabel(label)
        } else {
          setPasteUrl(null)
      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 pb-36 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-2.5">
            <ImageWithFallback src="https://raw.githubusercontent.com/wilooper/Asset/main/logo.png" alt="BmbMusic" className="w-10 h-10 rounded-xl object-contain flex-shrink-0" />
            <h1 className="text-xl font-bold tracking-tight">BmbMusic</h1>
          </div>
        ...
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-50"
          ...
          <div className="flex items-center gap-3 px-4 py-3 rounded-2xl
            ...
            <div className="min-w-0">
              <p className="text-sm font-medium truncate">Opening in BmbMusic…</p>
